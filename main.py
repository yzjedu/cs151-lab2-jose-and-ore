...
# Due Date: 9/25/2024
# Lab Assignment: 1
# What program does:This program that will determine the expected population
# in the future for a country based on a current population amount given (1) how often someone is born (in seconds),
